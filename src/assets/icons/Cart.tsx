const CartIcon = () => {
  return (
    ...
    >
      ...
      />
      <path
        d="M10.1047 9.07289C10.1047 5.79204 12.7644 3.13238 16.0452 3.13238C17.6251 3.12568 19.1425 3.7486 20.2621 4.86339C21.3816 5.97817 22.0109 7.493 22.0109 9.07289"
        stroke="#FF9F47"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
